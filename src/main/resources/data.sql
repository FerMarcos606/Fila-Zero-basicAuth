...
-- =====================================================
-- 2. CUSTOMERS (usuarios de prueba)
-- =====================================================
-- Password para todos: "password123"
-- Hash BCrypt: $2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhkm

INSERT INTO customers (username, email, password, role_id) 
...
(NULL, '12345678A', 'Juan', 'Pérez', 'Gómez', '+34612345001', 
        (SELECT id FROM customers WHERE username = 'juan.perez')),

(NULL, '23456789B', 'María', 'García', 'López', '+34612345002', 
        (SELECT id FROM customers WHERE username = 'maria.garcia')),

(NULL, '34567890C', 'Carlos', 'López', 'Ruiz', '+34612345003', 
        (SELECT id FROM customers WHERE username = 'carlos.lopez')),

(NULL, '45678901D', 'Ana', 'Martínez', 'Santos', '+34612345004', 
        (SELECT id FROM customers WHERE username = 'ana.martinez')),

(NULL, '56789012E', 'Luis', 'Fernández', 'Moreno', '+34612345005', 
        (SELECT id FROM customers WHERE username = 'luis.fernandez')),

(NULL, '67890123F', 'José', 'López', 'Martín', '+34612345006', 
        (SELECT id FROM customers WHERE username = 'jose.lopez'));
